...
public class ObjFolder {
    ...
    //It is the initial object of the category where objects are objFolders and Objs, and morphisms are generated by "as an element of" and equivlent morphism
    
    public static boolean Hom(ObjFolder A,ObjFolder B){//Category morphism, true represents there is morphism A->B(B as elements of A), and false reprents such morphism does not exists
